...
type CacheOptionsEntry struct {
	...
	// ID identifies this cache exporter.
...
type SolveResponse struct {
	...
	// responses from all output exporters and cache exporters.
	// It is deprecated in favor of the structured exporter responses.
...
// ExporterMetadata describes the exporter that produced a response.
